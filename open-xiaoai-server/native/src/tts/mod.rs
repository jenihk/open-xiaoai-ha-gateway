...
#[pyfunction]
#[pyo3(signature = (text, api_key, resource_id, speaker, speed=1.0, format="mp3".to_string(), sample_rate=24000, emotion=None, context_texts=None, playback_token=None))]
pub fn tts_stream_play(
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        ...
        let client = DoubaoStreamClient::new(api_key, resource_id, speaker);
...
#[pyfunction]
#[pyo3(signature = (text, api_key, resource_id, speaker, speed=1.0, format="mp3".to_string(), sample_rate=24000, emotion=None, context_texts=None))]
